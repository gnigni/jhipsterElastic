...
public class JhipsterElasticApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterElasticApp.class);

    private final Environment env;

    public JhipsterElasticApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterElastic.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterElasticApp.class);
